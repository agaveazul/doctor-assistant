...
// Define a type for the allowed color values
  ...
  (
    ...
    let classes = clsx(
      ...
      outline
        ...
        : plain
        ? styles.plain
        : clsx(styles.solid, styles.colors[color ?? "dark"]) // Using the defined type here ensures type safety
    );
    ...
    if (href) {
      return (
        <Link
          ...
          // {...filteredProps} // Only pass filtered props suitable for a link
        >
